            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="container mt-3">
                        <h1 class="h3 mb-4 text-gray-800">Tambah Data Unit</h1>
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header bg-primary text-white font-weight-bold">Form Tambah Unit</div>
                                    <div class="card-body">
                                        <form action="<?= base_url('Unit/tambah'); ?>" method="POST">
                                            <div class="form-row mb-3">
                                                <div class="col">
                                                    <label for="UNIT_PELAKSANA">Unit Pelaksana</label>
                                                    <input type="text" name="UNIT_PELAKSANA" id="UNIT_PELAKSANA" class="form-control" required>
                                                </div>
                                                <div class="col">
