        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-white active" aria-current="page">Data SOP</li>
                </ol>
                <h6 class="font-weight-bolder text-white mb-0">
                    <i class="fas fa-file-alt me-2 "></i> Data SOP
                </h6>
            </nav>
            <!-- ICON kanan -->
    ...
    <div class="container-fluid py-4">
        ...
        <div class="card mb-4 shadow border-0 rounded-4">
            <div
                ...
                <h6 class="mb-0">Tabel Data SOP</h6>
                <div class="d-flex align-items-center">
                    <a href="<?= base_url('Sop/tambah') ?>" class="btn btn-sm btn-light text-primary me-2">
            ...
            <div class="card-body px-0 pt-0 pb-2 bg-white">
                <div class="px-3 mt-3 mb-3">
                    <input type="text" id="searchInput" onkeyup="searchTable()" class="form-control form-control-sm rounded-3" placeholder="Cari SOP...">
                </div>
                                ...
                                foreach ($sop as $row): ?>
                                    <tr class="<?= ($no % 2 == 0) ? 'table-row-even' : 'table-row-odd'; ?>">
                                        ...
                                        <td class="text-center">
                                            <?php if (!empty($row['FILE_SOP'])): ?>
                                                <!-- Tombol Lihat -->
                                                <a href="<?= base_url('uploads/sop/' . $row['FILE_SOP']); ?>"
                                            ...
                                            <!-- Tombol Edit -->
                                            <a href="<?= base_url('Sop/edit/' . ($row['ID_SOP'] ?? '')); ?>"
                                                class="btn btn-warning btn-xs text-white me-1" title="Edit">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <!-- Tombol Hapus -->
                                            <a href="javascript:void(0);"
                                                onclick="confirmDelete('<?= base_url('Sop/hapus/' . ($row['ID_SOP'] ?? '')); ?>')"
...
<script>
    ...
    function searchTable() {
        ...
        const rows = document.querySelectorAll('#sopTable tbody tr');
        rows.forEach(row => {
