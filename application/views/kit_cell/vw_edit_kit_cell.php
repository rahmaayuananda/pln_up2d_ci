				...
				<form action="<?= base_url('Kit_cell/edit/' . urlencode($kit_cell['SSOTNUMBER_KIT_CELL'])); ?>" method="post">
					<div class="row g-3">
						...
						<div class="col-md-6">
							...
							<input type="text" class="form-control" name="NAMA_CELL" value="<?= htmlentities($kit_cell['NAMA_CELL']); ?>" required>
						</div>
						<div class="col-md-6">
							<label class="form-label">Jenis Cell</label>
							<input type="text" class="form-control" name="JENIS_CELL" value="<?= htmlentities($kit_cell['JENIS_CELL']); ?>">
						</div>
						<div class="col-md-4">
							<label class="form-label">Status Operasi</label>
							<input type="text" class="form-control" name="STATUS_OPERASI" value="<?= htmlentities($kit_cell['STATUS_OPERASI']); ?>">
						</div>
						<div class="col-md-4">
							<label class="form-label">Status SCADA</label>
							<input type="text" class="form-control" name="STATUS_SCADA" value="<?= htmlentities($kit_cell['STATUS_SCADA']); ?>">
						</div>
						<div class="col-md-4">
							<label class="form-label">Ratio CT</label>
							<input type="text" class="form-control" name="RATIO_CT" value="<?= htmlentities($kit_cell['RATIO_CT']); ?>">
						</div>
						<div class="col-md-4">
							<label class="form-label">Merk Cell</label>
							<input type="text" class="form-control" name="MERK_CELL" value="<?= htmlentities($kit_cell['MERK_CELL']); ?>">
						</div>
						<div class="col-md-4">
							<label class="form-label">Type Cell</label>
							<input type="text" class="form-control" name="TYPE_CELL" value="<?= htmlentities($kit_cell['TYPE_CELL']); ?>">
						</div>
						<div class="col-md-4">
							<label class="form-label">Tahun Cell</label>
							<input type="text" class="form-control" name="THN_CELL" value="<?= htmlentities($kit_cell['THN_CELL']); ?>">
						</div>
						<div class="col-md-6">
							<label class="form-label">Merk Relay</label>
							<input type="text" class="form-control" name="MERK_RELAY" value="<?= htmlentities($kit_cell['MERK_RELAY']); ?>">
						</div>
						<div class="col-md-6">
							<label class="form-label">Type Relay</label>
							<input type="text" class="form-control" name="TYPE_RELAY" value="<?= htmlentities($kit_cell['TYPE_RELAY']); ?>">
						</div>
						<div class="col-md-4">
							<label class="form-label">Tahun Relay</label>
							<input type="text" class="form-control" name="THN_RELAY" value="<?= htmlentities($kit_cell['THN_RELAY']); ?>">
						</div>
						<div class="col-md-8">
