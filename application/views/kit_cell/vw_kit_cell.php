                                ...
                                foreach ($kit_cell as $row): ?>
                                    <tr class="<?= ($no % 2 == 0) ? 'table-row-even' : 'table-row-odd'; ?>">
                                        ...
                                        <td class="text-center">
                                            <a href="<?= base_url('Kit_cell/detail/' . $row['SSOTNUMBER']); ?>" class="btn btn-info btn-xs text-white me-1" title="Detail">
                                                <i class="fas fa-info-circle"></i>
                                            </a>
                                            <a href="<?= base_url('Kit_cell/edit/' . $row['SSOTNUMBER']); ?>" class="btn btn-warning btn-xs text-white me-1" title="Edit">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <a href="<?= base_url('Kit_cell/hapus/' . $row['SSOTNUMBER']); ?>" class="btn btn-danger btn-xs btn-hapus" title="Hapus">
